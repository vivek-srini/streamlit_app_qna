...
def langchain_response(texts,embeddings,question):
    ...
    qa = RetrievalQA.from_chain_type(llm=ChatOpenAI(temperature=0,max_tokens=600,model = "gpt-3.5-turbo-0613",openai_api_key = openai_api_key), chain_type="stuff",retriever=retriever, chain_type_kwargs=type_kwargs)
